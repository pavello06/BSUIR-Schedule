...
abstract class AppLocalizations {
  ...
  /// No description provided for @courseNumber.
  ///
  ...
  /// No description provided for @foundedGroups.
  ///
  /// In en, this message translates to:
  /// **'{count, plural, =0{{count} groups found} one{{count} group found} other{{count} groups found}}'**
  String foundedGroups(num count);

  /// No description provided for @foundedTeachers.
  ///
  /// In en, this message translates to:
  /// **'{count, plural, =0{{count} teachers found} one{{count} teacher found} other{{count} teachers found}}'**
